                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="姓名" prop="username">
                                <el-input size="mini" class="inputW" v-model="userInfo.username" placeholder="请输入姓名" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="工号" prop="workNumber">
                                <el-input size="mini" class="inputW" v-model="userInfo.workNumber" disabled
                                    placeholder="请输入工号" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="手机" prop="mobile">
                                <el-input size="mini" class="inputW" :disabled="!!$route.params.id"
                                    v-model="userInfo.mobile" placeholder="请输入手机" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="入职时间" prop="timeOfEntry">
                                <el-date-picker size="mini" type="date" value-format="yyyy-MM-dd" class="inputW"
                                    v-model="userInfo.timeOfEntry" placeholder="选择入职时间" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="转正时间" prop="correctionTime">
                                <el-date-picker size="mini" type="date" class="inputW" v-model="userInfo.correctionTime"
                                    placeholder="选择转正时间" />
                            </el-form-item>
                        </el-col>
                    </el-row>
...
export default {
    components: { 'select-tree': SelectTree, 'image-upload': ImageUpload },
    data() {
        return {
            userInfo: {
                username: '', // 用户名
    ...
    created() { this.$route.params.id && this.getEmployeeDetail() },
    methods: {
        async getEmployeeDetail() {
            this.userInfo = await getEmployeeDetail(this.$route.params)
        },
        saveData() {
